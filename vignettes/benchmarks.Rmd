...
Benchmark the `integer()` approach to [PH Evaluator](https://github.com/HenryRLee/PokerHandEvaluator) using [reticulate](https://rstudio.github.io/reticulate/index.html).
